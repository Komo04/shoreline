...
return [
    ...
    'sample_rate' => env('SENTRY_SAMPLE_RATE') === null ? 0.5 : (float) env('SENTRY_SAMPLE_RATE'),

    // @see: https://docs.sentry.io/platforms/php/guides/laravel/configuration/options/#traces_sample_rate
    'traces_sample_rate' => env('SENTRY_TRACES_SAMPLE_RATE') === null ? 0.02 : (float) env('SENTRY_TRACES_SAMPLE_RATE'),
