  ...
  <div class="row justify-content-center">
    <div class="col-xl-10 col-lg-11">
      ...
      <div class="text-center mb-4">
        <h3 class="fw-bold mb-1">Edit Alamat</h3>
        <p class="text-muted mb-0">Perbarui alamat pengiriman Anda</p>
      </div>
            ...
            <div class="row g-4">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6 col-lg-12">
                    ...
                    <input
                      ...
                      name="nama_pengirim"
                      class="form-control form-control-lg"
                      value="{{ old('nama_pengirim', $alamat->nama_pengirim) }}"
                      required
                    >
                  </div>
                  ...
                  <div class="col-12">
                    ...
                    <input
                      ...
                      required
                    >
                    <div class="form-text">Hanya angka. Gunakan nomor aktif.</div>
                  </div>
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <div class="text-muted small">Cari wilayah bila ingin mengganti (opsional)</div>
                </div>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12 position-relative">
                    ...
                    <input
                      ...
                      autocomplete="off"
                      value="{{ old('search_wilayah', trim(($alamat->kelurahan && $alamat->kelurahan !== '-' ? $alamat->kelurahan . ', ' : '') . $alamat->kecamatan . ', ' . $alamat->kota)) }}"
                    >
                    ...
                    <input
                      ...
                      name="destination_id"
                      id="destination_id"
                      value="{{ old('destination_id', $alamat->destination_id) }}"
                    >
                    <div class="form-text">Jika tidak mengganti wilayah, biarkan seperti ini.</div>
                  </div>
      ...
      <div class="text-center mt-3 text-muted small">
        Pastikan alamat sesuai agar pengiriman tidak tertunda.
      </div>
...
@push('scripts')
<script>
  // === No Telp hanya angka (blok input selain digit, termasuk paste) ===
