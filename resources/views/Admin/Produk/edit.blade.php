...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        ...
        <small class="text-muted">Perbarui informasi produk pakaian</small>
    </div>
    ...
    <form method="POST" action="{{ route('admin.produk.update', $produk->id) }}" enctype="multipart/form-data">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi_produk" class="form-control" rows="4" required>{{ old('deskripsi_produk', $produk->deskripsi_produk) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="harga"
                                       value="{{ old('harga', $produk->harga_format) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="keterangan" class="form-control" rows="2" required>{{ old('keterangan', $produk->keterangan) }}</textarea>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="image-box mb-3">
                            <img id="previewProduk"
                                 ...
                                 class="{{ $produk->gambar_produk ? '' : 'd-none' }}">

                            <span id="previewText" class="text-muted {{ $produk->gambar_produk ? 'd-none' : '' }}">
                                Tidak ada gambar
                            </span>
                        </div>
                        ...
                        <input type="file" name="gambar_produk" class="form-control" accept="image/*"
                               onchange="previewImage(this,'previewProduk')">
        ...
        <div class="d-flex justify-content-end gap-2 mt-4">
            <a href="{{ route('admin.produk.index') }}" class="btn btn-light px-4">Kembali</a>
